...
def get_args():
    ...
    parser.add_argument('--init_ckpt', default=None, type=str, help='Initial checkpoint path for pretrained model')
...
def get_model(args):
    ...
    if 'cls_pt' in args.model:
        model = create_model(
            args.model,
            pretrained=args.init_ckpt is not None, #False,
...
def main(args):
    if "LOCAL_RANK" in os.environ:
        ...
        args.local_rank = -1 # Or handle non-distributed case as needed
