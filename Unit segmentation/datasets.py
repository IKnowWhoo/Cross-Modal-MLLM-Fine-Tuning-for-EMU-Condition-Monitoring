...
class DataAugmentationForBEiT(object):
    def __init__(self, args):
        custom_mean = [0.3, 0.3, 0.3] # replace this with your custom mean
        custom_std = [0.2, 0.2, 0.2] # replace this with your custom std
        imagenet_default_mean_and_std = args.imagenet_default_mean_and_std
        mean = custom_mean  # IMAGENET_INCEPTION_MEAN if not imagenet_default_mean_and_std else IMAGENET_DEFAULT_MEAN
        std = custom_std  # IMAGENET_INCEPTION_STD if not imagenet_default_mean_and_std else IMAGENET_DEFAULT_STD
...
def build_vqkd_dataset(is_train, args):
    ...
    #     t.append(transforms.RandomResizedCrop(args.input_size, scale=(args.min_crop_scale, 1.0),
