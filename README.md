...
* **[Qwen2.5-VL](https://github.com/QwenLM/Qwen2.5-VL/tree/main/qwen-vl-finetune)**: Our anomaly detection multi-modal large language model (MLLM) is based on their fine-tuning code.
